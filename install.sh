...
echo "If you're using GitHub Actions or other CI/CD, ensure your deployment"
echo "workflow includes git submodule initialization commands:"
echo ""
echo "  git submodule update --init --recursive"
echo "  git submodule update --remote"
echo "  composer dump-autoload --optimize"
echo ""
echo "See the README.md 'Production Deployment' section for complete examples."